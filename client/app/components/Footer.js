...
const content = {
  en: {
    ...
    company: { title: "Company", links: [{ label: "About Us", href: "/about" }] },
    ...
    legal: { title: "Legal", links: [{ label: "Privacy Policy", href: "/privacy" }, { label: "Terms of Service", href: "/terms" }] },
  ...
  ar: {
    ...
    company: { title: "الشركة", links: [{ label: "من نحن", href: "/about" }] },
    ...
    legal: { title: "قانوني", links: [{ label: "سياسة الخصوصية", href: "/privacy" }, { label: "شروط الخدمة", href: "/terms" }] },
